...
document.getElementById("contact").addEventListener("submit", async (e) => {
  ...
  const data = { firstName, lastName, email, phone, postal, message: userMessage };

  try {
    // const response = await fetch("https://script.google.com/macros/s/AKfycbzUWdLnvszPgMNmmYZKdVS0-UMPJ3IG8rEz6jur7n7QdiAGhkuFn_zr5p5p2WlJIIE8/exec", {
      method: "POST",
